...
if __name__ == "__main__":
    ...
    parser.add_argument('--columns', default='[1,2,33]', help='The number of variables used for training')
    ...
    parser.add_argument('--dataset_path', type=str,default='E:/autotherm-3CFF/parquetdata', help="Path to dataset.")
    ...
    #     callbacks=callbacks,
    #     deterministic=True,
    #     amp_backend='native' # make fix seed reproducable
    # )
    trainer = pl.Trainer(
        fast_dev_run=args.dev,
        accelerator="gpu",
